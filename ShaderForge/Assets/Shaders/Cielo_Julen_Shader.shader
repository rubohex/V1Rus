...
Shader "Shader Forge/Cielo_Julen_Shader" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _node_7886; uniform float4 _node_7886_ST;
            struct VertexInput {
...
////// Emissive:
                ...
                float2 node_4888 = float2((node_2963.r+i.uv0.r),i.uv0.g);
                float4 _node_7886_var = tex2D(_node_7886,TRANSFORM_TEX(node_4888, _node_7886));
                ...
                float node_9430 = 1.0;
                float3 emissive = (lerp(saturate((1.0-(1.0-_SkyColor.rgb)*(1.0-_node_7886_var.rgb))),_HorizonColor.rgb,pow((1.0 - max(0,dot(viewDirection,float3(0,-1,0)))),8.0))+(_LightColor0.rgb*pow(saturate((node_9430 + ( (max(0,dot((-1*lightDirection),viewDirection)) - node_1476) * (0.0 - node_9430) ) / ((1.0 - (node_9367*node_9367)) - node_1476))),5.0)*_SunIntensity));
