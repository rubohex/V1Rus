...
////// Lighting:
                ...
                float node_3345 = dot(lightDirection,i.normalDir);
                float3 finalColor = ((step(_AOintensity,_AmbientOcclusion_var.rgb)*_Color_var.rgb)*max(_Noise_var.rgb,floor(node_3345 * _Bands) / (_Bands - 1)));
